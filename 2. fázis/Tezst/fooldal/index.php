...
<body>
<div class="header">
    <a href="../filmek/film_lista.php"><h1 style="font-size: 36px;">Film Adatbázis</h1></a>
</div>
<?php
include '../header.php';
?>
    <nav>
        ...
        <ul>
            <br>
            <br>
            <li><a href="../regisztralas/register.php">Regisztráció</a></li>
            <br>
            <br>
            <li><a href="../kepgaleria/gallery.php">Saját képek</a></li>
            <br>
            <br>
            <li><a href="../bejelentkezes/delete_account.php">Fiók törlés</a></li>
        </ul>
    </div>
...
?>
    ...
    <p style="font-size: 18px; color: #000; background-color: #bfd7db ; line-height: 1.5;">Fedezze fel a végtelen filmvilágot a Filmkereső segítségével! Legyen szó klasszikusokról vagy legújabb blockbuster-ekről, nálunk minden film megtalálható. Böngésszen a legjobb kategóriákban, találjon új kedvenceket, és merüljön el a mozgókép mágikus világában. Nem számít, hogy Ön egy szenvedélyes filmrajongó vagy csak egy kikapcsolódásra vágyó, itt mindenki megtalálja a számára megfelelő filmet. Legyen részese az élménynek és hagyja, hogy a Filmkereső vezesse Önt a legújabb filmek és a kultikus alkotások világában. Hajrá, induljon el az utazásra már ma!</p>
</div>
